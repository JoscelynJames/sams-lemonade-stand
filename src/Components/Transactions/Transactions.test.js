...
function setup(address = '14EunREvgpgMZ4ivRbzLwMn4mH2k5FsWL2') {
	const props = {
		transactionArrays: [
			{
				address: '14EunREvgpgMZ4ivRbzLwMn4mH2k5FsWL2',
				txs: [
					{
						out: [
							{
...
describe('<Transactions />', () => {
	...
	it('returns data when getExchangeRate is called', done => {
		...
		mock.onGet('https://g-blockchain-info-api.herokuapp.com/ticker').reply(200, data);

		axios.get('https://g-blockchain-info-api.herokuapp.com/ticker')
